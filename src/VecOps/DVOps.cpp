...
DenseVector DVOps::DVMOps::matVecMul(const DenseMatrix& mat, const DenseVector& vec) {
...
DenseVector DVOps::DVMOps::vecMatMul(const DenseVector& vec, const DenseMatrix& mat) {
