...
DenseVector DVOps<DenseMatrix, DenseVector>::elemMult(const DenseVector& vecA, const DenseVector& vecB) {
...
DenseVector DVOps<DenseMatrix, DenseVector>::elemAdd(const DenseVector& vecA, const DenseVector& vecB) {
...
DenseVector DVOps<DenseMatrix, DenseVector>::elemSub(const DenseVector& vecA, const DenseVector& vecB) {
...
DenseVector DVOps<DenseMatrix, DenseVector>::elemDiv(const DenseVector& vecA, const DenseVector& vecB) {
...
DenseVector DVOps<DenseMatrix, DenseVector>::scalarMult(const DenseVector& vecA, const double val) {
...
double DVOps<DenseMatrix, DenseVector>::norm(const DenseVector& vecA, const double ord) {
...
double DVOps<DenseMatrix, DenseVector>::dot(const DenseVector& vecA, const DenseVector& vecB) {
...
double DVOps<DenseMatrix, DenseVector>::vecSum(const DenseVector& vec){
...
DenseVector DVOps<DenseMatrix, DenseVector>::DVMOps::matVecMul(const DenseMatrix& mat, const DenseVector& vec) {
...
DenseVector DVOps<DenseMatrix, DenseVector>::DVMOps::vecMatMul(const DenseVector& vec, const DenseMatrix& mat) {
